...
const Features = () => {
  return (
    <div id='product' className='py-8 md:py-40 flex justify-center relative'>
      <div className='w-[90%] max-w-[1800px] font-poppins flex flex-col md:flex-row gap-4 items-start'>
        ...
        <div className='flex flex-col gap-3'>
            ...
            <div className='lg:text-5xl md:text-4xl text-3xl font-semibold md:w-[80%]'>Why Choose FreshEase?</div>
          </div>
